...
|--------|------------------ |--------------- |-------------------------- |-------------- |------------------------- |
blac_1 | 0,0 | 0, | 0, | 0 | 0 |
blac_2 | 0,0 | 0,0 | 0,0 | 0 | 0 |
blac_3 | 0,00 | 0,0 | 0,0 | 0,000 | 0 |
...
En la siguiente tabla se muestran las medias calculadas para “Peso sin alimentar” en cada grupo. En el caso de que no haya una única moda, se muestran todos los valores separados por ;
